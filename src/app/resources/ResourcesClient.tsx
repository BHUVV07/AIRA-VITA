          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TECHNICAL_ARTICLES.map((art) => (
              <Link
                ...
                className="group bg-slate-50 hover:bg-white p-6 rounded-2xl border border-slate-200 hover:border-sky-300 shadow-xs hover:shadow-lg transition-all flex flex-col justify-between space-y-4"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-sky-700 bg-sky-100 px-2.5 py-1 rounded">
                      {art.category}
                    </span>
                  ...
                  <h3 className="text-base font-bold font-heading text-slate-900 group-hover:text-sky-700 transition-colors">
                    {art.title}
                  </h3>
                ...
                <div className="pt-3 border-t border-slate-200/80 flex items-center justify-between text-xs font-bold text-sky-700 group-hover:translate-x-1 transition-transform">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between mb-8">
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full pl-9 pr-3.5 py-2 text-xs bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredResources.map((res) => (
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-sky-700 bg-sky-50 px-2.5 py-1 rounded border border-sky-100">
                    {res.type}
                  </span>
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex-1 px-3 py-2 bg-sky-600 hover:bg-sky-700 text-white font-semibold text-xs rounded-lg transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-xs"
                >
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 space-y-4 shadow-2xl border border-slate-200">
            ...
            <div className="pt-2 flex gap-3">
              <button
                ...
                className="w-full py-2.5 bg-sky-600 hover:bg-sky-700 text-white rounded-xl font-semibold text-xs shadow-sm"
              >
