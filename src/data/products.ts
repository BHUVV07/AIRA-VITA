    ...
    subcategories: [
      {
        ...
        applications: [
          ...
          "Architectural room supply & return air",
          "Hotel lobby & corridor ventilation",
          "Cleanroom & office airflow control",
        ],
        features: [
          "High-Grade Extruded Aluminium Construction",
          "Electrostatic Powder-Coated White Finish (RAL 9010 / 9016)",
          "Aerodynamic Adjustable Core Disc",
          "Corrosion-Resistant & Washable Surface",
          "Bayonet Mounting Ring Clamp for Rapid Installation",
        ],
        specifications: {
          "Material": "Powder Coated Extruded Aluminium",
          "Finish": "Pure White RAL 9010 / RAL 9016",
          "Airflow Pattern": "360° Radial Dispersion",
          "Mounting": "Ceiling & Wall Mounting",
          "Operating Temperature": "-10°C to +80°C",
        },
        models: [
          { name: "ADV-AL 100", size: "Ø100 mm", application: "Standard supply / return", soundLevel: "< 25 dB(A)" },
          { name: "ADV-AL 125", size: "Ø125 mm", application: "Commercial office supply", soundLevel: "< 27 dB(A)" },
          { name: "ADV-AL 150", size: "Ø150 mm", application: "Medium airflow ceiling zone", soundLevel: "< 29 dB(A)" },
          { name: "ADV-AL 200", size: "Ø200 mm", application: "High airflow supply / return", soundLevel: "< 32 dB(A)" },
        ],
      },
      {
        id: "stainless-steel",
        ...
        applications: [
          ...
          "Hospitals & sterile healthcare zones",
          "Corrosive chemical & marine atmospheres",
        ],
        features: [
          "Grade 304 / Grade 316 Stainless Steel Construction",
          "Brushed Satin / Electropolished Finish",
          "Aerodynamic Low-Resistance Disc Core",
          "High Chemical & Corrosion Resistance",
          "Easy Demountable Disc for Thorough Cleaning",
        ],
        specifications: {
          "Material": "SS 304 / SS 316 Stainless Steel",
          "Finish": "Brushed Satin / Electropolished",
          "Airflow Pattern": "360° Radial Dispersion",
          "Mounting": "Ceiling & Wall Mounting",
          "Operating Temperature": "-20°C to +120°C",
        },
        models: [
          { name: "ADV-SS 100", size: "Ø100 mm", application: "Cleanroom / sterile zone", soundLevel: "< 24 dB(A)" },
          { name: "ADV-SS 125", size: "Ø125 mm", application: "Lab / kitchen exhaust", soundLevel: "< 26 dB(A)" },
          { name: "ADV-SS 150", size: "Ø150 mm", application: "Pharma cleanroom supply", soundLevel: "< 28 dB(A)" },
          { name: "ADV-SS 200", size: "Ø200 mm", application: "High-volume sterile zone", soundLevel: "< 31 dB(A)" },
        ],
      },
      {
        id: "abs-plastic",
    ...
    subcategories: [
      ...
      },
      {
        ...
        applications: [
          ...
          "Noise-sensitive commercial office areas",
          "Hospital wards & hotel room connections",
          "Cold air distribution networks preventing condensation",
        ],
        features: [
          "Multi-ply Aluminium Inner Core Construction",
          "25 mm High-Density Fiberglass Wool Insulation",
          "Aluminium Metalized Outer Vapour Barrier",
          "Superior Acoustic Noise Attenuation",
          "Prevents Thermal Energy Loss & Condensation",
        ],
        specifications: {
          "Core Construction": "1 ply Aluminium + 2 ply Polyester",
          "Insulation": "25 mm High-Density Fiberglass Wool",
          "Outer Jacket": "Aluminium Metalized Vapour Barrier",
          "Diameter Range": "102–508 mm",
          "Operating Temperature": "-30°C to +120°C",
          "Maximum Air Velocity": "30 m/s",
          "Maximum Operating Pressure": "2500 Pa",
          "Standard Length": "5 m / 10 m",
        },
      },
    ],
